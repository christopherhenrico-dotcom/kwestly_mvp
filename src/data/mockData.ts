...
export const MOCK_QUESTS: Quest[] = [
  ...
  },
  {
    ...
    description: 'Our Lambda functions have excessive cold start times (3s+). Need to analyze and reduce initialization overhead, implement connection pooling, and potentially use provisioned concurrency cost-effectively.',
    bounty: 175,
    difficulty: 'hard',
    ttl: 21600000,
    endTime: Date.now() + 21600000,
    minScore: 700,
    requirements: ['Profile current cold starts', 'Implement connection reuse', 'Reduce bundle size', 'Cost analysis for provisioned concurrency'],
    deliverables: 'PR with optimized Lambda code + benchmarks',
  },
  {
    id: '8',
    title: 'React Native Push Notifications',
    description: 'Implement Firebase Cloud Messaging for our React Native app with notification channels, deep linking, and local notification scheduling.',
    bounty: 125,
    difficulty: 'medium',
    ttl: 18000000,
    endTime: Date.now() + 18000000,
    minScore: 450,
    requirements: ['FCM integration', 'Deep link handling', 'Local notifications', 'Permission handling for iOS/Android'],
    deliverables: 'Demo app + documentation',
  },
  {
    id: '9',
    title: 'GraphQL Rate Limiting Middleware',
    description: 'Build a rate limiting middleware for our GraphQL API using Redis. Implement per-user, per-IP, and field-level rate limiting with configurable thresholds.',
    bounty: 225,
    difficulty: 'hard',
    ttl: 25200000,
    endTime: Date.now() + 25200000,
    minScore: 800,
    requirements: ['User-based rate limiting', 'IP-based rate limiting', 'Field-level granularity', 'Configurable via environment'],
    deliverables: 'Middleware code + test suite',
  },
  {
    id: '10',
    title: 'iOS App Privacy Manifest Compliance',
    description: 'Create Apple-required privacy manifest for our iOS app, documenting all required reasons APIs and third-party SDK data collection practices.',
    bounty: 80,
    difficulty: 'easy',
    ttl: 7200000,
    endTime: Date.now() + 7200000,
    minScore: 200,
    requirements: ['NSPrivacyAccessedAPIType reasons', 'Third-party SDK disclosure', 'App Store submission ready', 'Xcode project integration'],
    deliverables: 'PrivacyInfo.xcprivacy file + README',
  },
];
